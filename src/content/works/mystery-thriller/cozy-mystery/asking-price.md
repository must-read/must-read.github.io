...
workX: "The Adventure of the Blue Carbuncle by Arthur Conan Doyle"
workY: "A Drink Before the War by Dennis Lehane"
wordCount: 2669
...
status: "published"
formulaSummary: >
  Doyle's deductive performance and detective-as-moral-authority meet Lehane's
  working-class specificity and community complicity. A florist in a gentrifying
  Boston neighborhood investigates why an elderly neighbor sold his house against
  his stated wishes, reading every physical clue correctly inside a framework
  that is fundamentally wrong. The trivial mystery unfolds into real human stakes,
  but mercy — when it comes — costs more than she expected.
synopsis: >
  When her elderly neighbor sells the house he swore he'd never leave, florist
  Bette Kiernan investigates. Her deductions are flawless. Her conclusions about
  who the victims are — and who the villains are — are not.
combination:
  fromAuthorA:
