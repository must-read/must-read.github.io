...
synopsis: "Dr. Elspeth Froom's critical edition of a forgettable 14-line nature poem has grown to 78 footnotes. The early annotations are charming. The late ones propose things. The tone never changes."
combination:
  fromAuthorA:
...
Dr. Pettifer's assertion that the line is "padding to maintain the meter" reflects the same critical acuity that led him to describe Tench's late work as "repetitive," an evaluation roughly as useful as noting that the sea contains salt. One does not expect illumination from a man who has spent his career mapping territories he has never visited, but even by Pettifer's standards, the remark was spectacularly unhelpful — rather like being handed an umbrella in a drought and told it might come in useful.
...
I do not wish to dwell on the matter of funding, except to observe that the University of East Wessex, Dr. Pettifer's institution, has maintained a Chair in Applied Cartographic Studies at a cost of approximately £340,000 per annum for the past fourteen years. The Chair's output, during this period, has consisted of eleven papers, a co-edited conference proceedings, and a textbook that is used in two universities, one of which is East Wessex itself. I mention this not out of any desire for institutional comparison — such comparisons being, as a rule, as illuminating as comparing a cathedral to a parking structure — but because the funds currently allocated to Applied Cartographic Studies would, if redirected, support a Chair in Speculative Cartography for approximately eighteen years, during which time considerable progress might be made on problems that Pettifer's department has shown no interest in solving. I include a projected budget in Appendix F.

[*Footnotes 27–29 omitted*]

**30.** On the matter of line 14 and its closing image ("their own dull council long past me"), I should like to propose, with the calm that accompanies settled conviction, that this line constitutes not merely the conclusion of the poem but a statement of principle regarding the proper relationship between the human observer and the observed world. The stones will keep their council. They do not require our attention. They do not benefit from our interpretation. They will persist. Tench understood — and here I part company not only with Dr. Pettifer but with the broad consensus of contemporary literary studies — that the purpose of criticism is not to serve the reader but to serve the text. The text is the thing. The reader is merely the temporary and often inadequate vessel through which the text passes on its way to permanence.

This has implications for how we structure our critical institutions. If the text is primary and the reader secondary, then we must ask: who should be permitted to mediate between them? Not everyone. Not, certainly, those who approach the text with the assumption that it means what it appears to mean — the positivists, the literalists, the Pettifers. The text requires *advocates*. Interpreters who will fight for its hidden content. Scholars who will devote decades to a single poem, not because the poem is popular, but because it is *important*, and the distinction between popularity and importance is precisely the distinction our institutions have lost the will to enforce.
...
**37.** The now-standard definition of "dorse" (see n. 8) — a sheltered assembly, a gathering defined by enclosure — provides, I think, the key to the entire poem, and I confess I am surprised that it has taken me until this late stage of the commentary to articulate what must, to any attentive reader, have been obvious from the beginning. The poem is a dorse. It is a sheltered space. It holds its contents — the light, the stones, the gull, the dark — in the same way a room holds furniture: not by force but by the simple fact of surrounding them. And the commentary — this commentary — performs the same function at a larger scale. The poem is a dorse; the commentary is a dorse around the dorse. I am the walls.

I mention this not out of vanity but out of a recognition that without my annotations Tench's poem has no human reality at all, since the human reality of such a poem as his — being too slight and reticent for a canonical work — must depend entirely on the reality of its annotator and her circumstances, attachments, and so forth, a reality that only my notes can provide.
...
The world has treated this poem the way it treats all things of quiet, stubborn value — by looking through it toward something louder. I intend to make that impossible. I intend to annotate this poem until it cannot be ignored. I intend to build such an edifice of commentary around these fourteen lines that anyone who encounters them will be forced to reckon with what they contain, or at the very least to reckon with the fact that someone — one person, working alone, in a department of one, with a cat — believed they contained everything.
