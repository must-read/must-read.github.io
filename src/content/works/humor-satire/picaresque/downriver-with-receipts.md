---
title: "Downriver with Receipts"
slug: "downriver-with-receipts"
genre: "humor-satire"
subgenre: "picaresque"
authorA: "Mark Twain"
authorB: "Nora Ephron"
...
combination:
  fromAuthorA: ["Vernacular American voice with deadpan observational humor", "The con artist as protagonist — specifically the Duke/King pattern of arriving in a town, running a scheme, and being run out", "Satirical exposure of small-town pretension and human folly through episodic encounters"]
  fromAuthorB: ["Self-conscious personal narration where every anecdote is pre-shaped for maximum comedy", "Sharp observation of class signifiers, social rituals, and the performance of competence", "The comedy of someone curating their own failure into a success story in real time"]
  fromWorkX: ["Picaresque episodic structure — a journey through a series of towns, each a self-contained encounter revealing the same truth from a different angle", "The river/road as connective tissue between episodes, the car as raft", "Each community visited becomes a satirical portrait of American social pretension"]
  fromWorkY: ["The protagonist's central interpretation of events is fundamentally wrong — visible to the reader, invisible to the narrator", "The gap between the narrated version and the actual events mirrors Quixote's gap between what he sees and what is there", "The refusal to wake up — the story ends with the delusion intact, the protagonist walking into the next windmill"]
---
