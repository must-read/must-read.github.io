---
title: "The Department of Honesty"
slug: "the-department-of-honesty"
genre: "humor-satire"
subgenre: "political-satire"
authorA: "Joseph Heller"
authorB: "Evelyn Waugh"
workX: "Catch-22"
workY: "Scoop"
wordCount: 5311
...
status: "published"
formulaSummary: >
  Heller's escalating circular logic and bureaucratic self-consumption fused
  with Waugh's surgically precise upper-class cruelty and devastating
  understatement. Catch-22's recursive structure — rules that devour
  themselves, authority as its own punishment — meets Scoop's portrait of
  powerful institutions that are definitionally incompetent, producing a
  transatlantic pincer movement on the political class.
synopsis: >
  When Parliament creates a Department of Honesty to restore public trust,
  its first regulation requires all officials to be honest — except about
  the Department itself, which must never admit it isn't working.
combination:
  fromAuthorA:
