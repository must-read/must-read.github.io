...
status: "published"
formulaSummary: >
  Mantel's institutional proceduralism and McEwan's close-but-not-invaded interiority
  shape the portrait of a contamination-control engineer whose triumph is measured in
  the distance between her skin and an asteroid sample, told as a logistical expedition
  narrative where material substances carry the weight of human meaning.
synopsis: >
  A contamination-control engineer spends the final 72 hours before the OSIRIS-REx
  capsule lands in Utah executing the protocols she spent seven years designing,
  preparing to receive 250 grams of asteroid that she must never touch.
combination:
  fromAuthorA:
