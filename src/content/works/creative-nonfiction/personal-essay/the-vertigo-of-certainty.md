---
title: "Verification Notes, Week of November 11"
slug: "the-vertigo-of-certainty"
genre: "creative-nonfiction"
subgenre: "personal-essay"
authorA: "Rachel Cusk"
authorB: "Joan Didion"
workX: "Outline"
workY: "The White Album"
wordCount: 2505
...
formulaSummary: >
  ...
  a fact-checker's private notes file where professional verification and personal
  inventory of failed certainties occupy the same digital space, each contaminating
  the other until the procedures meant to establish truth expose how thin the narrator's
  own certainties have always been.
synopsis: "A fact-checker's private notes from a week spent debunking a conspiracy theory. Between verification entries, she keeps a second list — things she was certain about and got wrong."
combination:
  fromAuthorA:
...
> 1. Dad served in Korea.
> 2. The lake house had a green door.
> 3. I failed the bar the first time because I didn't study.
> 4. Rob was lying about where he went that night in 2011.
> 5. Mom knew about the money before I told her.
...
Wes asked at the 2:00 meeting how the verification was going. I said the sourcing didn't hold up. He said: keep going, see what survives. He was eating an apple. He said it the way he says most things, as if the outcome is already known and the process is a courtesy we extend to the process.
...
Jamie does not know about the card. I have not told him. This is its own kind of certainty — the certainty that some corrections are not worth making because the structure they would damage is inhabited, and the people living in it have arranged their furniture, and to renovate now would be to ask them to live somewhere provisional while the work is done, and no one wants to live somewhere provisional.
...
I wrote that sentence down. I have looked at it several times since. It is the kind of sentence that sounds like it means something. It might mean something. It means, I think, that he has confused the feeling of understanding with understanding itself, and that the feeling is so strong, so structurally complete, that he cannot distinguish it from knowledge. I have sympathy for this. More than I should.
...
The procedures worked. The verification process identified what was false and flagged what was unsubstantiated and protected the magazine from publishing a story that could not be defended. This is what the process does. This is what I do. I establish what can be established and I mark what cannot and I write it down and I file it and the document goes into the system and the system holds.

---

**Personal**

I count nine items on the list now. Nine things I was certain about and got wrong. Some are trivial. Some are not. The distinction between trivial and not-trivial is itself a certainty I have not examined — the belief that the street in Philadelphia matters less than the birthday card, that being wrong about a direction is different in kind from being wrong about a mother. Maybe it is different. Maybe the difference is the certainty I am most reluctant to check.

Alana called. Not texted — called. She wanted to know if I'd started my own list. I said I had. She asked how many items. I said nine. She said, "Is it making you feel better or worse?" I said I didn't know yet. She said that was the right answer, and I said I wasn't sure there were right answers to questions like that, and she laughed and said, "See, that's what I mean. We admit it."

I am looking at my phone. The verification report is in one app. The list is in another. They are adjacent. The phone does not distinguish between them. Both are notes. Both are data. Both are a woman establishing what she knows and what she doesn't, using the same device, the same fingers, the same
