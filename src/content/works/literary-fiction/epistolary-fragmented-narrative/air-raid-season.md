...
synopsis: "Two Ukrainian women exchange voice messages during the 2026 Winter Olympics — one broadcasting from a Kyiv studio between air raid alerts, the other watching from Toronto while her son asks if the people on television are real."
combination:
  fromAuthorA:
...
*Oksana: Kyiv, Ukraine (UTC+2)*
*Daryna: Toronto, Canada (UTC-5)*
