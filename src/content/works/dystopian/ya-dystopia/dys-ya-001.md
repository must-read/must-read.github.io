...
synopsis: "In a school system where every student earns points, levels up, and can see every metric, fifteen-year-old Sable notices one number that doesn't add up — and discovers the transparent system was never meant to be looked at, only looked through."
combination:
  fromAuthorA:
