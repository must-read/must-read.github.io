---
title: "The Keeping Season"
slug: "the-keeping-season"
genre: "dystopian"
subgenre: "feminist-dystopia"
authorA: "Margaret Atwood"
authorB: "Kazuo Ishiguro"
workX: "The Handmaid's Tale"
...
status: "published"
formulaSummary: >
  Atwood's wry political awareness and historical grounding in bodily control fused
  with Ishiguro's devastating understatement and narrators who circle the truth without
  naming it. The Handmaid's Tale provides the architecture of reproductive oppression;
  Never Let Me Go provides the emotional register — compliance as horror, the boarding
  school as gentle prison, the narrator's refusal to fully comprehend.
synopsis: >
  At a lakeside school for young women chosen for the Keeping Program, Lena recalls
  her years of preparation with calm precision — never quite naming what she and the
  others were kept for, or what it cost them.
combination:
  fromAuthorA:
