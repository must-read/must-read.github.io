---
title: "Bright Compliance"
slug: "bright-compliance"
genre: "dystopian"
...
She arrived home. She ate within nutritional guidelines. She logged her Brightness affirmation — I am visible, I am clear, I am known — and the affirmation went into the system and the system received it the way it received all things, without judgment, without weight, without the capacity to distinguish between a statement spoken in belief and a statement spoken from the place where belief used to be, a place now occupied by something that looked like belief and functioned as belief and could not be distinguished from belief by any metric the Bureau possessed, because the Bureau measured speech and the speech was correct and the Bureau measured behavior and the behavior was standard and the Bureau measured the citizen and the citizen was bright.

And in the space between the measurement and the thing measured, in that gap so small that no instrument could detect it, Elara Doss was not. Not gone. Not absent. Not resistant or compliant or deviant or adjusted. She was the gap itself — the distance between a word and its meaning, between a light and the thing it illuminates, between a system that sees everything and the everything that is not seen. She was the discrepancy that the system had declared was not a discrepancy. She was the address that existed in the past but not in the present. She was the shadow that the building code specified should not exceed fifteen centimeters but that fell, in the last minutes before she closed her eyes, in the last minutes when the residential lighting dimmed from its daytime standard to its nighttime standard and the transition between the two created, briefly, a penumbral zone in which shadows could extend without regulation, she was the shadow that fell across the floor of her regulation apartment and reached, for three seconds, the length of a whole person before the nighttime standard took hold and the shadow contracted and the brightness returned and the gap closed and the measurement resumed and Elara was, once again, bright.
