---
title: "Debriefing the Ghosts"
slug: "debriefing-the-ghosts"
...
status: "published"
formulaSummary: >
  Barker's stripped, clinical gaze at the institution that repairs soldiers to
  destroy them again meets Nguyen's double-exposed confession — the narrator who
  is also the thing being examined. A Vietnamese psychiatrist at a Saigon military
  hospital uses borrowed French methods to rehabilitate ARVN soldiers for a war
  whose meaning belongs to everyone except the people fighting it.
synopsis: >
  A Vietnamese psychiatrist at a Saigon military hospital in 1972 treats ARVN
  soldiers for combat trauma using inherited French methods, while concealing
  that her dead father fought for the other side.
combination:
  fromAuthorA:
