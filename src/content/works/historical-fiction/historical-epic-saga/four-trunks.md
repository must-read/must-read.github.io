...
subgenre: "historical-epic-saga"
authorA: "Min Jin Lee"
authorB: "Amitav Ghosh"
workX: "Middlesex by Jeffrey Eugenides"
workY: "Wild Swans by Jung Chang"
wordCount: 7880
...
The currency was demonetized twice — once in 1985, once in 1987 — and both times my mother lost whatever she had managed to save. My father kept teaching. The curriculum changed with each new directive from the education ministry, and my father taught whatever they told him to teach with the same careful neutrality he applied to everything. He was not a coward. He was a man who had calculated, correctly, that survival required a particular relationship to conviction — not the absence of conviction, but the discipline to keep it separate from speech.
...
She was performing the chain of causation that mothers perform when they want you to understand that nothing is separate from anything else. I took the documents. I held them the way I'd seen my grandmother hold them — gingerly, not because they were fragile but because they were volatile. Paper that can change who you are should be handled with care.
...
The recipe is the fifth trunk. The one no one can carry for you. The one that weighs nothing and contains everything, and that will disappear when I do, because I have no daughter to stand beside me in the kitchen and learn the pressure of my wrists, and because writing it down — which I have considered, which I have a notebook ready for — would turn it into something it has never been: information. And a recipe is not information. A recipe is a practice. It lives in a body or it doesn't live at all.

On Sundays, for as long as my hands work, the steam fills the kitchen, and for a few hours I am not the last of anything. I am in the middle.
