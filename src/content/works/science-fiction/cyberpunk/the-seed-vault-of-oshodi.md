---
title: "The Seed Vault of Oshodi"
slug: "the-seed-vault-of-oshodi"
...
status: "published"
formulaSummary: >
  Gibson's neon-noir sensory overload and brand-name realism collide with Butler's
  unflinching humanism and community-as-resistance ethos. A Neuromancer-style heist
  plot gives way to Parable of the Sower's journey structure, as a neural-jacked
  Lagos hustler discovers that the AI she's cracking dreams not of escape but of
  building something worth staying for.
synopsis: >
  A neural-jacked street hustler in corporate-controlled Lagos is hired to crack
  an AI, only to discover it's dreaming of building a community beyond the city
  walls — and that the real heist was never about data at all.
combination:
  fromAuthorA:
