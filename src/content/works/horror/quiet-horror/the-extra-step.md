...
status: "published"
formulaSummary: >
  Jackson's spare, psychologically precise prose meets Enriquez's Latin American
  social horror. Structured like Hill House's slow architectural dissolution of
  sanity, but grounded in the Dangers of Smoking in Bed's insistence that the
  supernatural and the systemic are the same wound.
synopsis: >
  A woman moves into a cheap Buenos Aires apartment where the stairwell has one
  too many steps and the hallway angles refuse to add up — but her neighbors
  treat the wrongness as normal, the way you treat poverty when it's all you know.
combination:
  fromAuthorA:
