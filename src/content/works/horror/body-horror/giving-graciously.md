---
title: "Giving Graciously"
slug: "giving-graciously"
genre: "horror"
subgenre: "body-horror"
authorA: "Carmen Maria Machado"
authorB: "Thomas Ligotti"
workX: "The Vegetarian"
workY: "Annihilation"
wordCount: 3451
...
combination:
  fromAuthorA: ["Translucent fingernails examined with clinical-erotic precision", "The body as text — something that can be read, misread, rewritten", "Fairy-tale logic beneath corporate surface — the ribbon, the secret the body carries"]
  fromAuthorB: ["The all-hands meeting as nightmare document — PowerPoint as existential horror", "Corporate wellness language as the vocabulary of surrender", "The compliance spreadsheet as the last refuge of a dissolving self"]
  fromWorkX: ["Radical bodily transformation as refusal of the bounded autonomous self", "The gap between what the observer sees as pathology and what the body experiences as becoming", "Body developing architecture for forces that don't exist yet"]
  fromWorkY: ["Mutation without malice — the body finding a new way to organize", "Scientific vocabulary applied to impossible biological events", "The institutional apparatus managing transformation by refusing to call it what it is"]
---
...
Diane said this the way she said everything — lightly, as though the implications of what she was saying were a kind of weather that would pass. Lena watched her eat the carrot. The fluorescent light caught the skin of Diane's forearm, and Lena saw — or thought she saw, or knew she saw — the same faint green tracery beneath the surface. Diane did not seem to notice. Diane had three children's cells in her brain and a company's engineered tissue integrating into her organs and she was eating hummus and she was fine.

Lena looked at the veins in her wrists pulsing their soft green light. She thought: my body was designed for this. She thought: designed is the wrong word. She thought: there is no right word, and the absence of a right word is the most frightening thing that has happened to me in six months, more frightening than the nails, more frightening than the bones, because I can file a report about a nail but I cannot file a report about the failure of language to contain what I am becoming.
...
The Quiet Room was on the fourth floor, behind a door with a frosted-glass panel and a brass placard that read RESTORATION SPACE. It had been, before the build-out, a boiler room, and it retained the boiler room's proportions — low ceiling, thick walls, a sense of enclosure that the facilities team had tried to offset with potted ferns and a Bluetooth speaker that played binaural beats at frequencies supposedly calibrated to parasympathetic activation. Lena went there on Thursdays for her mandatory breathing exercises. The Reciprocal Donation enrollment contract specified two thirty-minute sessions per week in the Quiet Room. She had not read this clause carefully before signing.
...
Not their thoughts. Not their emotions. Their tissue. A kind of cellular awareness, like the way your tongue finds a new filling — probing, involuntary, precise. She could feel Jay two floors down, the signature of his changed tissue registering in her own like a harmonic. She could feel Diane in the kitchen. She could feel the intern from bioprocessing in the parking garage, smoking a cigarette he thought no one knew about. She felt them the way you feel the walls of a room in the dark — not seeing, not touching, but knowing where they are through some proprioception of shared matter.
...
The binaural beats pulsed. The ferns grew. Lena breathed and felt the building full of people who were becoming something, and the something had no name, and the absence of a name felt not like a deficit but like a clearing.
...
Not because the observations were wrong. Because the framework was wrong. The report presupposed a self that was being acted upon — a bounded, sovereign entity called Lena Vasilko whose body had deviated from specifications and required corrective action. The report presupposed that the specifications were correct. That the body described in the enrollment paperwork — discrete, individual, sealed — was the body she had ever actually had, as opposed to the body she had been told she had by her parents the dentists, by her regulatory science program, by every form she had ever signed that asked her to check a box confirming she was one person.

She was not one person. She had never been one person. The microchimerism whitepaper was right about that much: the body was permeable, always had been, and the fiction of impermeability was a regulatory convenience, a way to assign liability, a way to make the paperwork come out clean.

The cursor blinked. The report waited. She could send it and the program would pause and an independent evaluator would come in and they would measure her collarbone struts and test her olfactory sensitivity and they would write their own report and the reports would nest inside each other like matryoshka dolls, each one smaller and more precise and further from the thing they were trying to contain. And Lena would go back to her studio apartment in the Pearl District and sit on her IKEA couch and her body would be a coat again, a coat at a party she wasn't invited to, and the green light in her wrists would fade, and the cellular awareness would dim, and she would be sovereign and bounded and alone.
...
The report disappeared. The screen showed her empty inbox. She sat for a moment with her hands on the keyboard, the translucent nails catching the amber light from the Edison bulbs, and she felt something she had not felt before, or had felt but had never permitted herself to name, because naming it would have required a form that did not exist: relief. Not the relief of solving a problem. Not the relief of a deviation corrected, a parameter met, a box checked. The relief of a body that has been holding its breath for thirty-one years and has finally, finally been given permission to exhale — and what comes out is not air but something older and greener and more honest than air has ever been.

She went back to the open-plan office. It was a Tuesday. She had drafted the report on Friday and spent the weekend not sending it and deleted it this morning and now it was a Tuesday and the distinction between Friday and Tuesday had started to feel less important than other distinctions that were also starting to feel less important. The Edison lights cast their amber light on the participants' changed skin. Through the glass walls, Portland was gray and wet and going about its business.
...
She opened her compliance spreadsheet. Three hundred and forty-seven rows of other people's deviations. She scrolled to the bottom. She added a 348th row. In the first column she typed her own name. In the second column: "Transformation status." In the third column, after a pause long enough to hold everything she could not say — to her parents, to the enrollment form, to the regulatory science program at Oregon State, to every document she had ever written that pretended the body was a closed system — she typed:

*Within parameters.*

She saved the file. She did not know whose parameters she meant. Outside the glass walls of the office, it was raining, and the rain sounded like the building breathing, and the building sounded like her, and the distinction between these things had started to feel — not wrong, not collapsed, just — optional. The kind of thing you stop noticing. The kind of thing you stop wanting to notice. The kind of thing that, once you stop, you cannot remember why you ever did.
