...
formulaSummary: >
  ...
  of The Grifters recast as mother-daughter inheritance, inside the sealed
  household economy of We Have Always Lived in the Castle — told by a
  narrator whose sweet voice never cracks, even when describing the mechanism
  underneath.
synopsis: >
  A daughter describes her quiet life with her mother in a small Missouri
  town — the gardening, the casseroles, the neighborly care — in a voice so
  warm it takes pages to notice she has never once used the word steal.
combination:
  fromAuthorA:
