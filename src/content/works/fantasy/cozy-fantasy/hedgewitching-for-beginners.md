...
synopsis: >
  When the ancient beech tree anchoring her village's weather ward begins
  dying, hedgewitch Bramble Hopworth throws every remedy she knows at the
  problem. None work. The tree's bonded badger is dying too, and the only
  answer is one Bramble can't bring herself to accept.
combination:
  fromAuthorA:
