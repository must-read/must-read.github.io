---
title: "Desire Path to a Counting Room"
slug: "fan-lowfantasy-001"
genre: "fantasy"
subgenre: "low-fantasy"
authorA: "Brandon Sanderson"
authorB: "Neil Gaiman"
workX: "The Master and Margarita by Mikhail Bulgakov"
workY: "Piranesi by Susanna Clarke"
wordCount: 5776
...
synopsis: "A proofreader has spent eleven years mapping the impossible rules of her apartment — acoustic dead zones, desire paths worn by no one, a window that sometimes faces a courtyard that doesn't exist. Then a building inspector arrives with instruments that can almost measure what she's been hiding."
combination:
  fromAuthorA:
...
She capped her pen and stood, knees cracking, and went to the kitchen to make coffee. The kitchen window faced the brick wall of the adjacent building, as it should, as it did most mornings. The brick was old and reddish-brown and she knew every crack in it the way a prisoner is said to know every crack in the walls of his cell, although she had never thought of it in those terms. She was not a prisoner. She had a lease. She paid rent. The rent was stabilized at a figure that belonged to a different decade, and this was one of the reasons she stayed, and it was not the main reason.
...
She watched him fill out his forms in the living room, his clipboard balanced on one knee, and she had the disorienting sensation of seeing her apartment translated into another language. His language had categories for everything she lived with, but the categories were wrong in the way a map is wrong when it shows a river as a blue line — technically accurate, functionally useless if what you need to know is whether the river will flood. His forms rendered the apartment ordinary. The forms were not lying. They were just speaking a dialect that had no word for what she knew.
...
Two days. Gone. Not blacked out — she didn't feel hungover or ill or disoriented in the way people describe after seizures or fugue states. She felt rested. She felt fine. She felt, if anything, clearer than usual, the way you feel after a long sleep that you didn't know you needed. Her body showed no signs of having been anywhere unusual. Her clothes were the same. Her teeth felt unbrushed, which was normal for two days without brushing, and this mundane detail — the furred teeth, the stale mouth — was somehow the most frightening part, because it meant her body had been here the whole time, doing ordinary body things, while her mind was somewhere she could not account for.
...
That was wrong. She rephrased it in her mind as she stood there: she found entries she did not remember writing. Because the handwriting was hers. The notation system was hers — the abbreviations, the shorthand, the specific symbols she'd invented in year two for recurring phenomena (a circle with a line through it for a dead zone boundary, a wavy line for a desire path, a square for the courtyard window). The pen was hers — the same blue Pilot G-2 07 she always used, and she could see where the ink had been pressed harder on downstrokes in the way her hand naturally pressed harder on downstrokes.
...
She sat down on the floor and read the entries from the beginning. It took an hour. When she finished she felt something she could not name, something worse than fear, which was this: whoever had used her hands and her notebook and her pen during those lost days was better at her job than she was. Not better at proofreading — better at observing the apartment. Better at the thing she had organized her entire life around. As if the apartment had found a way to do its own research, and the instrument it used was her.
...
"You're always busy. You've been busy since you moved into that apartment. Before that you were a person. Now you're busy."

Linnea didn't say anything. Through the kitchen window — brick wall today, ordinary light — she could hear traffic on the street below, and a dog barking, and someone's car alarm going through its cycle of wails. Normal sounds. She found herself listening to them with a hunger that surprised her, the way a person who has been ill craves plain food.
...
After they hung up, Linnea stood in the kitchen for a long time. She was thinking about something Britt had said — *before that you were a person* — and trying to remember what that person had been like. She could recall facts: she had liked Thai food, had run a half-marathon once, had read novels for pleasure instead of reading them the way she read everything now, with one ear cocked for the apartment's commentary. She had laughed more. She was fairly sure she had laughed more. But the memory of laughing was like the memory of a meal — you could remember that it happened, you could even remember that you enjoyed it, but the taste was gone.

She was thinking about the notebook entries she hadn't written, the ones that were better than hers, and she was thinking about eleven years and what they had cost and whether cost was even the right word for something you chose every day without knowing you were choosing.
...
The sound hit her first. Or rather: the absence of sound hit her. Not silence. She knew silence — she lived next to pockets of it every day. This was deeper. This was the sound underneath silence, the sound that silence is the surface of. It was like standing at the edge of a hole in the earth and feeling the cold air rising from a depth you cannot see. Except the cold was quiet, and it rose into her ears and filled them and for a moment she could not hear her own breathing and she was afraid, genuinely afraid, for the first time since the early notebooks, since year one when she had not yet learned to live alongside the thing in her apartment's geometry.

She stepped through.

The room was small, as the notebook entry had described. Cold. Lit by light from a window that faced the courtyard — the phantom courtyard, which from this angle looked less phantom and more ordinary: cobblestones, the stone trough, a drainpipe running down the opposite wall with a mineral stain below its mouth. She could see it clearly, closer than she had ever seen it through the kitchen window. A pigeon was sitting on the edge of the trough. Its feathers were wet. It looked real. Everything looked real in the way that the realest things look — not vivid, not heightened, just there, with the solidity of objects that do not need to be observed in order to exist.

The counting table was in the center of the room. She recognized it from the notebook entry's description: a wooden table, scarred by use, its surface divided into a grid of lighter and darker squares. Not painted — the pattern was in the wood itself, two different species joined with a craft that pre-dated the building by centuries. The squares were the size of playing cards. Some of them were darker than others, stained by something she could not identify.
...
She opened notebooks at random. Each one was different. Each one was the same. Some were meticulous — every page dated, every measurement repeated three times, error margins calculated. Some were scattered — observations mixed with grocery lists, phone numbers, complaints about the landlord. One notebook, its cover almost entirely detached, contained nothing but drawings: careful, repeated sketches of the desire paths' configurations on different dates, like stop-motion frames of something moving too slowly to watch.

Twenty-two notebooks. At least five different handwritings. Spanning — she checked the earliest dates she could find — at least forty years. Forty years of people living in this apartment and observing and recording and, she understood now with a clarity that felt like stepping out of a warm building into winter air, losing time. All of them. Every one of these careful, methodical observers had sat where she sat and mapped what she mapped and built systems that worked, that predicted, that were accurate — and none of them had seen what she was seeing now, which was that they were not the first. That the apartment did not have an observer the way a person has a hobby. It had a position. A role. Like a job listing that gets filled and vacated and filled again, the work continuing regardless of who does it.

She was the latest. She was not the only.

She stood in the counting room — she was already calling it that, already naming it, which was the kind of thing she had learned not to do but she was tired of not doing it — and she looked at the notebooks and she looked at the window and she looked at the courtyard pigeon, which looked back at her with the flat, disinterested gaze of an animal that has seen many people stand at this window and has not found any of them remarkable. The quiet in the room pressed against her eardrums like altitude. She could feel it as a physical thing, a weight, the accumulated silence of decades of observation by people who had each believed they were alone with the strangeness.
...
She picked up the oldest notebook she could find — the one with the detached cover and the drawings — and held it in both hands and felt its weight, which was ordinary, the weight of a composition book, and she carried it out of the room and she did not close the door behind her.
...
She did not show him. Not the room — not yet, maybe not ever. She did not know whether the room would be there when he looked, or whether it would be a closet wall, plaster and brick, and she would be a woman with a falling-apart notebook full of drawings, standing in a mess of painter's tape, asking a building inspector to believe her. She was not willing to find out. Not today.
...
"I've been doing this for six years," he said. "Residential inspections. You see a lot of buildings. Most of them make sense. Some of them don't, and when they don't, you write it up as something that does, because the form has fields for insulation and ventilation and structural integrity and it does not have a field for —" He gestured at the notebook. At the tape on the floor. At the kitchen window, which today, right now, with a stranger sitting at the table and the morning light pouring in, faced not the brick wall but the courtyard: the cobblestones, the stone trough, the drainpipe with its mineral stain. A pigeon on the lip of the trough, fluffing its wet feathers.
...
He turned back to the table. He picked up her notebook and opened it and began to read, and she let him, and she went to the window and stood there and looked at the courtyard that should not exist and listened to the sounds coming through the glass — a pigeon, traffic, a dog — and the sounds were loud. Louder than they should have been. Louder than they had been in eleven years. Street noise pouring through the window with the pressure and insistence of water through a crack, as if the apartment's careful, insulating quiet had been punctured and the ordinary world was rushing in to fill the gap.

It hurt. The loudness. Not her ears — something else. Something that had grown accustomed to the muffled quality of her days, the way the apartment swallowed the sounds she didn't need to hear and left her in a pocket of managed stillness where her work — her real work, the observation, the notebooks, the careful mapping of a thing she did not understand — could proceed without interruption. The street noise was an interruption. The dog barking was an interruption. Gil turning pages behind her was an interruption. The whole world, with its careless, unmanaged, unmapped noise, was interrupting something, and she stood at the window and felt it and did not turn around.

Behind her, Gil read. The courtyard light came through the glass and fell on the kitchen floor in a pattern she had never seen before — not because the light was new but because she was standing in a different spot than usual, at a different angle, and the light had always done this, probably, when no one was watching. When the apartment had the kitchen to itself. She thought about the notebooks in the counting room, twenty-two of them, twenty-two people who had stood at this window or one like it and watched this light or light like it, and she thought about the twenty-third notebook, which was hers, and about the twenty-fourth, which would belong to whoever came after her, and she did not know if that thought was a comfort or the opposite of comfort but she held it anyway, the way you hold a cup of coffee that has gone cold but you don't put it down because putting it down would mean admitting the morning is over.
