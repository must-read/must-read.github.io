---
title: "Varnis and Grieving"
slug: "varnis-and-grieving"
genre: "fantasy"
subgenre: "epic-high-fantasy"
authorA: "J.R.R. Tolkien"
authorB: "Ursula K. Le Guin"
workX: "A Game of Thrones"
workY: "The Fifth Season"
wordCount: 6604
readingTimeMinutes: 27
tags:
  - epic-high-fantasy
  - multi-pov
  - geological-oppression
  - systemic-violence
  - ambiguous-ending
  - cultural-erasure
  - myth-and-memory
...
She knew, for instance, that varnis was not uniform. Under a hand lens, quarried granite showed crystal structure -- consistent, angular, interpretable. Varnis showed something else. Layers. Compressed strata that, under magnification, revealed variations in color and density so fine they looked like the growth rings of an ancient tree. She had once counted forty-seven distinct layers in a sample no wider than her thumb. Each layer was different. Each layer contained fragments that, if she did not know better, she would have called worked.

Shaped. Intentional.

She did not know better. She had stopped pretending she did the year she found a piece of varnis in the sub-foundation of the Treasury wing that contained, compressed to the thickness of a fingernail, what was unmistakably a carved lintel. The carving was too crushed to read, but the tool marks were there -- the regular spacing of a chisel driven by someone who knew their craft. The lintel was not embedded in the varnis. The lintel had been *compressed into* the varnis. Made part of it. As if the entire stratum had once been a built environment, a city or a district or a room, and something -- time, pressure, the weight of the world laid on top of it -- had flattened that environment into mineral aggregate.
...
Something was making this sound. Something in the varnis, something compressed and layered and impossibly old, was vibrating in a pattern that Oluye, who had spent nineteen years listening to stone, had never heard before.

She leaned closer. The vibration shifted -- not in response to her proximity, she told herself, though the timing was troubling. It shifted the way a voice shifts when the singer moves from humming to almost-words. The pattern acquired structure. Intervals between pulses shortened, lengthened, shortened again. A cadence. A rhythm that was not her heartbeat and was not the earth's pulse and was, she realized with a cold shock that traveled from her wrist to the base of her skull, familiar.
...
He nodded. The spectacles sat on the chart like a second pair of eyes, staring at data that did not require interpretation. "How many Attenuators do we have rated for deep-fault deployment?"
...
Davonn picked up his spectacles and put them back on. He looked at the chart. The epicenters were migrating toward Varchenmor with the regularity of an appointment kept.

"Tell the supervisor to document it," he said. "Nothing else. We don't need a distraction."

Orath left. Davonn stood at the window and watched the rooflines darken as the afternoon clouds came in from the west. He did not think about the signal Teshen was hearing. He thought about the seven-century cycle and the eleven Attenuators he had left, and he calculated — carefully, methodically, with institutional continuity foremost in his mind — how long the ground would hold.

---

## III. Teshen

She felt the fault the way you feel a splinter you can't see -- a wrongness just beneath the surface, hot and directional. The earth here was stressed along a line running northeast, the pressure building in the compressed strata sixty meters down where the basalt met something older and less stable. She knelt on the exposed rock at the deployment site, palms flat, collar humming against her throat, and she reached.

Reaching was what they called it in training. The word was wrong. It implied extension, a hand stretching toward something distant. What Teshen actually did was closer to opening. She opened the channels in her nervous system that connected to the earth's stress — or that the earth's stress connected to, the direction had never been clear — and she let the pressure flow through her.

It hurt. It always hurt. The pain was in her spine first, then her shoulders, then radiating down her arms into her fingers where they pressed against the stone. She had been told it would get easier. It had not gotten easier. It had gotten more familiar, which was different. She knew the pain now the way you know the layout of a room you navigate in the dark. The geography of it. Where the worst of it accumulated. How to move through without stumbling.

She dampened. That was the other word, and it was closer to accurate. She took the building pressure in the fault and spread it — not eliminated, never eliminated, just distributed across a wider area, the way a dam distributes the force of a river into its structure. Small tremors along a hundred kilometers of fault instead of one catastrophic release at this point. The buildings above her would not fall. The people in those buildings would feel nothing.

The collar tracked her neural load. When it turned amber, she was approaching threshold. When it turned red, the override would activate — a kill-switch that severed her connection to the earth. They had explained the override during her first year, when she was nine and the word "sever" had sounded clinical rather than lethal. She understood it better now. The override did not simply cut the connection. It cauterized. An Attenuator whose override activated would live, usually, but the channels that had been opened would be closed permanently, seared shut, and the resulting neurological damage was — the word they used was "significant."
...
She had been hearing it for months. Each attenuation brought it closer — not louder but clearer, like a voice emerging from a crowd as you learn to distinguish it from the ambient roar. At first she had thought it was an artifact of the process, her own nervous system producing phantom patterns from the chaos of tectonic data. Then she had heard the repetition. The same sequence of intervals, recurring at irregular but not random spacings, like a phrase in a language she almost recognized.

Today it was close. Today the melody — she could not help calling it that — was close enough that she could follow individual intervals, and as she followed them, holding the attenuation steady with what had become reflex, she felt something shift in her understanding like a key finding its tumbler.

She knew this melody. Not all of it. A fragment. Four notes, a pause, three notes descending — the shape her mother had hummed on the mornings when Oluye braided her hair, the sound Teshen associated with warmth and the smell of hearth-bread and the particular quality of light that came through the kitchen window in their apartment in the Overhang Quarter before the assessors came and the apartment became a place she'd lived once and could not return to.

The earth was singing her mother's song.

Or — and the distinction mattered, she understood this even as the realization made her hands tremble against the stone and her collar flicker toward amber — her mother's song was a fragment of the earth's song. A piece broken off and passed down through generations of women who had forgotten everything about it except how it sounded. The melody had survived the forgetting of its own meaning. It had come down through hands and throats and kitchen mornings, and here it was in the rock, complete, the rest of the song that her mother's fragment belonged to.
...
She could still hear the melody. Faint now, without direct contact, but present — the way you hear a song that has been stuck in your head all day, not truly audible but unignorable.
...
The crack she'd been repairing was not a crack. It was a seam — a line where two different compositions of varnis met, one dense and dark, the other fractionally lighter and threaded with mineral veins that, under her hand lens, resolved into patterns she could not read but recognized as intentional. Script. Carved or pressed into the material before it was compressed, and compressed so thoroughly that the letters — if they were letters — had been flattened to the width of a thread.

She followed the seam deeper. Past the foundation gallery, past the cistern vaults where the city's water supply was collected and filtered, into passages that appeared on no maintenance map she had ever been given. The lamp threw her shadow long and strange against walls that were no longer varnis and granite but solid varnis — compressed aggregate from floor to ceiling, the layers visible in cross-section where water erosion had exposed them.

In the deepest passage, she found the adit.

It was a horizontal opening driven into the compressed strata, sealed with Compact-era mortar — fresh by the standards of this depth, no more than four or five centuries old. Someone had known this was here and had closed it. Oluye worked at the mortar with her chisel for an hour. It was good mortar, well-mixed, and whoever had applied it had been skilled. She respected the workmanship even as she destroyed it.

Behind the seal: a chamber.

Not large. Perhaps ten paces across, with a ceiling that curved upward to a point — a vault, she realized, a deliberately shaped space within the compressed strata. The walls were lined with varnis so densely layered that the strata resolved, under her lamp, into something that stopped her breath.

Architecture. Compressed architecture. The remnants of walls and columns and lintels, crushed into centimeters of thickness but still bearing the ghost of their original forms. She could see — or believed she could see, which in the lamplight amounted to the same thing — the lines of doorways, the curves of arches, the regular spacing of structural supports. A building, or a district, or a quarter of a city, flattened into geology. And within the flattened architecture, objects: the compressed shapes of vessels, of tools, of things she had no name for because the culture that had made them had been driven so deep into the earth that their names had become mineral.

The Kethrani. She did not say the word aloud. She did not need to. Everyone in Varchenmor knew the name, the way everyone knows the name of something that is not discussed. A people who had lived here before the Compact. Conquered. Absorbed. *Compressed* — and she heard the word now in a new register, literal rather than historical, the euphemism of textbooks made suddenly, physically real.

The chamber was resonating. Not the faint pulse she'd felt in the service gallery but a full, complex vibration that she felt in her sternum and the roots of her teeth. The sound was not loud. It was *present* — occupying the space the way heat occupies an oven, something the air itself had become. And in the center of the chamber, where the vault reached its highest point, the compressed strata had not been merely flattened. They had been shaped.

Not carved. Grown. The formations rose from the floor like stalagmites, but their surfaces were too regular, too deliberately curved, and they were hollow — tubular, flared at their tops, narrowing at their bases. Acoustic instruments. Oluye understood this immediately, the way she understood the properties of any material she worked with. Strike these and they would sing. They were *already* singing, vibrating at a frequency generated by the stressed strata around them, the very pressure that had compressed the Kethrani's world into stone now driving the air through their instruments and producing sound.

She walked among them. There were dozens. Each was different — different diameter, different flare, different curvature. Each produced a different tone. Together they formed something that was not music, exactly, but was not noise either. It was — she searched for the word and did not find it. It was the sound of a civilization that had been reduced to geology remembering that it had once been alive.

And among them, near the chamber's far wall, she found one that produced her mother's song.

The fragment. The four-note, three-note phrase that she had hummed without knowing what it was, that she had taught to Teshen without knowing what she was teaching. It was here, in the compressed remains of a world she had spent her life building on top of, and it had never been a lullaby. It had been a Name-Song. A song that was not about a person but was a person — the acoustic identity of someone who had lived and died and been sung into the ground in a tradition so old that only the melody survived, carried by women who had forgotten everything except the sound.

She had taught Teshen a piece of the earth's memory. She had braided her daughter's hair and hummed a dead woman's name and called it comfort.

Oluye stood in the chamber with her lamp guttering and the instruments of the Kethrani dead singing around her, and she wept, and the stone wept with her, or the stone's vibration coincided with the rhythm of her grief in a way that could have been resonance or could have been the ordinary mathematics of pressure and frequency and chance.
...
"No," Perou said. "It does not." She removed her spectacles and cleaned them with a cloth that had been mended twice. "But the Kethrani believed it did, and they organized their civilization around that belief. Their architecture was acoustic — buildings designed to resonate at specific frequencies, the way an instrument is shaped to produce a particular tone. Their burial practice involved singing the deceased's — the term is difficult to translate — their *name-essence* into the ground, into specific geological formations that they understood as repositories. Living stone as archive. The dead not gone but stored." She set down the cloth. "When your Compact built its cities on those formations—"

She stopped. Replaced her spectacles. Picked up the fragments. Her foot had stopped tapping. The silence in the basement office was the silence of a woman who had calculated the precise distance between what she knew and what she could safely say, and had found the margin narrower than she liked.

"I am an archivist," she said. "I describe what the sources say. I do not interpret."

Davonn understood. The sentence she had stopped herself from completing would have been an accusation: that the Compact had built its civilization on the graves of the Kethrani, and that the earth's cyclical violence was not a natural phenomenon to be managed but a response to be reckoned with. It was mythology. It was not his concern.

He returned to the Authority headquarters. He climbed the stairs to his office. He sat at his desk and opened the latest deployment report and read the numbers — eleven Attenuators, two approaching diminishment, the central-basin faults converging on Varchenmor — and then a tremor hit.
...
Davonn stood over the crack. It was a hand's width across at its widest point, narrow enough that a man could step across it, wide enough that he could see into it. The crack ran down through the concrete, through the sub-foundation, into what lay beneath.

From the crack, rising with the air that the earth's shifting had displaced, came sound. Not the rumble of settling stone. Not the hiss of compressed air. A sound with structure. A sound with intervals. A sound that, if Davonn had been the kind of man who recognized melody, he would have called singing.
...
She knelt on the exposed rock in the deepest service tunnel they could reach, a passage that had been cut through varnis and basalt for the Authority's monitoring equipment, and she placed her hands on the stone and opened.
...
Not a fragment. Not the half-heard melody of previous attenuations. The full song, enormous, structured, layered — voices, she would have said, if the word "voices" could be stretched to include the acoustic signatures of compressed civilizations vibrating under tectonic stress. The song filled the fault. It was the fault. The pressure she had been trained to suppress was itself a sound, and the sound was not random, and the sound was not geology, and the sound was the Kethrani dead singing their Name-Songs in the only medium left to them: the stone that had swallowed them.

Her collar turned amber. Then red. The override hummed. She had seconds before it activated — before the kill-switch burned her channels shut and left her alive and empty and released into whatever life awaited an Attenuator past diminishment.
...
Not dampen. Conduct. Channel the pressure upward, through the strata, along the fault lines that ran beneath the city's foundations. Let the earth speak. Not absorb its voice but amplify it. Serve as conduit rather than dam. The city above would crack. The burial-song halls would be exposed. The Compact's dampening walls — nineteen years of Oluye's careful repair — would fracture and the compressed strata would sing at full resonance for the first time in seven hundred years.
...
The shift was immediate. The pressure in the fault reversed direction — not upward, exactly, but outward, expanding through the stressed strata along paths that felt, to Teshen's shattered senses, like channels that had been waiting. The stone had known. The fault lines were not random fractures but routes, carved by old pressures or by intention she could not distinguish from intention, and the energy she channeled followed them the way water follows a streambed.

In the service gallery above, Oluye felt the floor buck and grabbed the nearest wall. The varnis under her hands was warm. It was vibrating at a frequency she felt not in her bones but in the hollow spaces of her body — throat, sinuses, the cavity of her chest. The instruments in the burial-song hall behind her were resonating at full voice, the compressed air driven through their tubes at pressures they hadn't experienced since the morning the Compact sealed them in. The sound was enormous. It was not one voice but hundreds, thousands — the layered Name-Songs of the Kethrani dead, each one distinct, each one a person who had lived and been sung into the ground, and the ground was giving them back.

Or the ground was breaking, and the sound was the acoustic signature of structural failure, and what Oluye heard was not voices but the physics of compressed material vibrating at its resonant frequency under catastrophic stress, the way a bridge hums before it collapses. Both were true. Neither was more true than the other.

The fissure ran through the lowest level of the city. It followed the line of the burial-song halls with a precision that could have been guided or could have been the natural consequence of channeling pressure through the weakest strata. The dampening walls cracked. The varnis courses that Oluye and every mason before her had maintained for centuries split along their compressed layers, and in the exposed cross-sections the Kethrani architecture became visible — not to scholars or to archivists but to anyone standing in the service galleries as the dust settled, anyone with eyes, the crushed remains of a civilization laid open like the pages of a book.

Oluye sang. She did not decide to. The fragment — her mother's fragment, the Name-Song she had carried without understanding — rose out of her throat the way the sound rose out of the stone, and for a moment the two sounds aligned. Her voice and the earth's voice. The fragment and the whole. Whether the stone answered her or whether the coincidence of frequencies was just that — a coincidence, two sounds in the same register occupying the same space at the same time — she could not tell and did not try. She sang, and the chamber sang, and the fissure widened, and the city above groaned in a register that could have been agony or release.
...
He looked at the collar. He carried the Warden's override — a device, palm-sized, that could trigger any Attenuator's kill-switch from a distance. He had used it once, eleven years ago, on an Attenuator whose attenuation had destabilized during a deep-fault deployment. The Attenuator had survived. She had not walked again, and her name was a number in a file that Davonn kept in his desk and did not open.
...
Teshen would be destroyed. Not killed — the override rarely killed — but emptied. Every channel in her nervous system cauterized. The girl who could hear the earth's voice would become a girl who heard nothing, and the nothing would last the rest of her life.
...
He removed his Warden-Surveyor's insignia — the silver pin he had worn for twenty-eight years, the mark of his office, the symbol of a man whose identity was institutional continuity. He held it for a moment. It was warm from his body.

He set it on the ground.

Then he knelt beside Teshen and placed his hands on the stone. He could not feel what she felt. He had no gift, no channels, no connection to the earth's voice. The stone under his palms was just stone — cold, gritty, vibrating faintly with forces he could not interpret.

But he knelt there. A man who had stopped serving. A man who, for the first time in twenty-eight years, was not standing between the earth and its voice but simply present, a body on the ground, neither suppressing nor conducting, neither holding the system together nor tearing it apart.

Whether this was wisdom or abdication depended on what you believed a man owed the institutions that had shaped him. Davonn knelt, and the earth spoke through the girl beside him, and he did not know what it was saying.
...
Her hands were encased in mineral deposits where the crystalline formations had completed their growth — rinded in new stone, the way a tree branch becomes embedded in the rock of a cliff face over centuries, except this had taken minutes. She could not move her fingers. She might never move them again. The collar was dead, its circuits fused by the surge that had passed through her or by the override that Davonn had not triggered — or had he? The device in his pocket, when he checked it later, showed an activation log that was corrupted, unreadable, neither confirming nor denying. The question of whether the collar had been killed by the earth's voice or by the Warden's mercy would not resolve.

She was deaf. The resonance had been so massive, so sustained, that the hair cells of her inner ears had been destroyed. She would hear nothing for the rest of her life. But she could still feel the stone. She pressed her rinded hands against the ground and felt, beneath the settling, beneath the aftershocks and the groaning of damaged foundations, a quietness.

The earth was quiet. Whether it was quiet because it had been heard — because the song had been sung, the Name-Songs given back to the air, the seven centuries of compressed silence finally broken — or because the pressure had been released and the geological system was simply returning to equilibrium, the way any stressed material relaxes after fracture — this was the question Teshen carried, and would carry, and would not answer, because she could not hear the silence well enough to know what kind of silence it was.

---

In the burial-song hall, Oluye stood among the shattered instruments and the exposed strata and wept for reasons she could not fully separate. Grief for her daughter, whom she had not found. Grief for the Kethrani dead, whose songs were fading as the resonance ebbed. Grief for herself — for the nineteen years of repair, of sealing and patching and maintaining the walls that had kept this place silent. She had been good at her work. She had been proud of it. The work had been the suppression of something she did not have a word for, and the absence of the word was itself a kind of suppression, and she was only now beginning to understand how many kinds of silence she had been maintaining.

The instruments were cracked. Some had shattered entirely, the compressed strata too brittle to survive the resonance they'd produced. Others stood, vibrating faintly, their sounds diminishing as the pressure that had driven them eased. In the exposed cross-sections of the walls, the Kethrani architecture was visible — compressed doorways, compressed lintels, the crushed geometry of rooms that had been inhabited and were now mineral. Oluye looked at them the way a mason looks at any structure: assessing damage, calculating repair, estimating the weight of what remained.

She could not repair this. No one could repair this. The walls had been opened and what was inside them was visible and the visibility could not be undone.

She did not know if that was enough.

---

Above the city, where the fissure had reached the surface in three places, something was happening that the Geological Authority had no framework to classify. Mineral-rich water from the deep strata — forced upward by the pressure release, carrying dissolved calcium carbonate from formations that had been sealed for centuries — was precipitating on contact with the open air. Tufa. White calcium towers forming in real time, growing from the cracks in the city's foundations at a rate visible to the naked eye. An inch an hour. Then two. The formations rose from the ruins like columns, like the supports of a building that had not yet been designed, their surfaces rough and porous and faintly iridescent where the mineral content caught the light.

The people of Varchenmor gathered to watch them grow. Some saw architecture. New buildings rising from the bones of the old, the city remaking itself from material that had been locked beneath it for seven hundred years. Others saw chemistry. Precipitation. A process no more meaningful than the mineral deposits that form in any cracked pipe, given sufficient pressure and dissolved calcium and time. The formations would stop growing when the water stopped flowing. They were not architecture. They were residue.

Both groups watched the same towers. Both groups were correct about what they saw.

The towers grew. The water flowed. The fissure steamed in the cooling air of the afternoon, and from the cracks in the foundation the last of the Kethrani Name-Songs rose and dispersed into the atmosphere, where they were indistinguishable from wind.

Davonn stood in what had been his office and was now an open wound in the building's structure, the crack running through his floor, his desk split along the grain, his deployment charts scattered in the dust. His spectacles were broken. He had stepped on them without noticing. He held his insignia in his palm. He had not put it back on. He had not thrown it away. It sat in his hand, silver, warm, meaningless or essential depending on whether the man holding it was still the man who had earned it. Outside his shattered window the towers grew, and he watched them with the expression of a man seeing something he had no category for — not wonder, not horror, but the blankness that precedes both.

Below the city, Oluye climbed toward the surface. She did not find Teshen. She did not know Teshen was two hundred meters away, deaf and rinded in new stone, alive in a way that the word "alive" might need to expand to accommodate. She climbed because the passage was open and the air was moving and somewhere above her the sky was doing something she had not seen from below ground in nineteen years of working the deep courses. Mortar dust covered her arms and face. Her chisel was still in her belt, habit so deep it had survived the cracking of everything the chisel was meant to maintain. She would reach the surface. She would see the towers. She would not know what they meant.

None of them would. The towers grew. The water flowed. Somewhere in the deep foundations, a single instrument of the Kethrani dead — the one that had carried a mother's song, or a dead woman's name, or both — cracked along a grain that had been stressed for seven centuries, and fell silent. Or fell into a silence that was different from the silence before: not the silence of suppression but the silence that follows sound, full of the shape of what it carried, the air still holding the impression of the voice that had moved through it, the way stone holds the impression of the thing it once was, the varnis and the grieving, at the last, the same substance under different names.
