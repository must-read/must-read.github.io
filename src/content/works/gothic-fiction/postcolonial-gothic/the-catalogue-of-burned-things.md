---
title: "The Catalogue of Burned Things"
slug: "the-catalogue-of-burned-things"
genre: "gothic-fiction"
subgenre: "postcolonial-gothic"
authorA: "Carlos Ruiz Zafón"
authorB: "Mariana Enríquez"
workX: "The Shadow of the Wind"
...
status: "published"
formulaSummary: >
  Zafón's lush bibliophilic Gothic and his vision of the city as labyrinth
  merge with Enríquez's spare, brutal depictions of Argentina's political
  violence and the uncanny embedded in the everyday. The result is a story
  where books and disappearance are the same wound, and Buenos Aires is
  both cathedral and crypt.
synopsis: >
  A young archivist at the National Library of Buenos Aires discovers her
  dead grandmother's diary among an uncatalogued donation — and finds that
  its pages reference books that don't exist, names that recur across
  decades, and a house that burned down during the dictatorship.
combination:
  fromAuthorA:
